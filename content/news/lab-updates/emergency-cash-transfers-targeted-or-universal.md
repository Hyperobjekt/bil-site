...
{{% personbreaker headshot="/uploads/david-calnitsky.jpg" name="David Calnitsky" title="Assistant Professor, Department of Sociology at the University of Western Ontario" %}}
...
{{% personbreaker headshot="/uploads/jim-pugh.jpg" name="Jim Pugh" title="Co-founder, Universal Income Project" %}}
...
{{% personbreaker headshot="/uploads/juliana-bidadenure.jpg" name="Juliana Bidadanure" title="Assistant Professor of Philosophy & Director of the Stanford Basic Income Lab, Stanford University" %}}
...
{{% personbreaker headshot="/uploads/miranda-perry-fleischer.jpg" name="Miranda Perry Fleischer" title="Professor of Law and Co-Director of Graduate Tax Programs, University of San Diego" %}}
...
{{% personbreaker headshot="/uploads/sheida-elmi.jpg" name="Sheida Elmi" title="Research Program Manager, Insights and Evidence, Financial Security Program" %}}
...
{{% fancyblockquote attrib="Ugo Gentilini" %}}There is longstanding debate on targeting versus universality, and the bottom line is that no program scores highly on all possible parameters of performance—coverage, adequacy, costs, and progressivity.{{% /fancyblockquote %}}

{{% personbreaker headshot="/uploads/ugo-gentilini.jpg" name="Ugo Gentilini" title="Senior Economist and Global Lead for Social Safety Nets at the World Bank Group" %}}
